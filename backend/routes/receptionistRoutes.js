...
router.get('/receptionist/stats', async (req, res) => {
...
router.get('/receptionist/queue', async (req, res) => {
    const today = new Date().toISOString().split('T')[0];
    try {
...
router.get('/receptionist/verify-arrival', async (req, res) => {
...
router.post('/receptionist/mark-arrived', async (req, res) => {
...
router.post('/receptionist/register-patient', async (req, res) => {
    const {
...
router.get('/receptionist/appointments', async (req, res) => {
