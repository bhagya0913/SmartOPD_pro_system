...
router.get('/lab/worklist', async (req, res) => {
...
router.get('/lab/patient-tests', async (req, res) => {
...
router.post('/lab/update-status', async (req, res) => {
